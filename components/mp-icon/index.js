/**
 * mp-icon — 企业级 SVG 图标组件
 * 基于 Lucide/Feather 图标路径，stroke 风格，支持自定义颜色和尺寸
 * 用法: <mp-icon name="search" size="32" color="#94a3b8" />
 */
...
var ICON_PATHS = {
  ...
  // 营销 & 商业
  crown: '<path d="M2 18h20l-2-9-4 4-4-7-4 7-4-4-2 9z"/><path d="M2 18h20v3H2z"/>',
  zap: '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>',
  users: '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
  gift: '<polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/>',
  ticket: '<path d="M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2z"/><path d="M3 12h18"/>',
  truck: '<rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/>',
  shield: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>',
  recycle: '<path d="M7 19l-3-3 3-3"/><path d="M4 16h11a4 4 0 0 0 0-8"/><path d="M17 5l3 3-3 3"/><path d="M20 8H9a4 4 0 0 0 0 8"/>',
  ...
  utensils: '<path d="M3 2v7c0 1.1.9 2 2 2h0a2 2 0 0 0 2-2V2"/><path d="M5 2v0"/><path d="M5 11v11"/><path d="M19 2v20"/><path d="M19 2h0a3 3 0 0 1 3 3v3a3 3 0 0 1-3 3h0"/>',
...
function buildSvg(name, color, size) {
  var path = ICON_PATHS[name];
  if (!path) return '';
  var s = size || 24;
  var c = color || '#64748b';
  var svg = '<svg xmlns="http://www.w3.org/2000/svg" width="' + s + '" height="' + s + '" viewBox="0 0 24 24" fill="none" stroke="' + c + '" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">' + path + '</svg>';
  // encode for url()
...
Component({
  ...
  observers: {
    'name,size,color': function (name, size, color) {
      ...
      this.setData({ bgImage: buildSvg(name, color, size) });
    },
  },
  attached: function () {
    if (this.data.name) {
      this.setData({ bgImage: buildSvg(this.data.name, this.data.color, this.data.size) });
    }
  },
});
